...
export default async function handler(
  ...
  // Log para depuração
  console.log('[PRISMA] Verificando sessão em tests:', session ? 'Autenticado' : 'Não autenticado');
  ...
  console.log('[PRISMA] Forçando reconexão do Prisma antes de buscar testes');
