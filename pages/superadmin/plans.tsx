...
const validationSchema = Yup.object({
  ...
  maxUsers: Yup.number().min(1, 'Mínimo de 1 usuário').required('Limite de usuários é obrigatório'),
  maxCandidates: Yup.number().min(1, 'Mínimo de 1 candidato').required('Limite de candidatos é obrigatório'),
  ...
  const handleAddPlan = async (values: any, { resetForm }: any) => {
    try {
      const planData = {
        ...
        maxCandidates: parseInt(values.maxCandidates),
                ...
                initialValues={
                  isEditing && currentPlan
                    ? {
                        ...
                        maxCandidates: currentPlan.maxCandidates,
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="mb-4">
                        ...
                        <Field
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        />
                        <ErrorMessage name="maxUsers" component="div" className="mt-1 text-sm text-red-600" />
                      </div>

                      <div className="mb-4">
                        <label htmlFor="maxCandidates" className="block text-sm font-medium text-gray-700 mb-1">
                          Máx. Candidatos
                        </label>
                        <Field
                          type="number"
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        />
                        <ErrorMessage name="maxCandidates" component="div" className="mt-1 text-sm text-red-600" />
                      </div>
                    </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {plans.map((plan) => (
                        <tr key={plan.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-xs text-gray-900">{plan.maxUsers} Usuários</div>
                            <div className="text-xs text-gray-900">{plan.maxCandidates} Candidatos</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
