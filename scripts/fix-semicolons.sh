...
# Script para corrigir pontos e vírgulas faltantes nas importações de authOptions
...
echo -e "${GREEN}Iniciando correção de pontos e vírgulas nas importações...${NC}"

# Encontrar todos os arquivos que têm a importação de authOptions sem ponto e vírgula
FILES=$(find /home/jean/avaliarh/pages -type f -name "*.tsx" -exec grep -l "import { authOptions } from '@/pages/api/auth/\[...nextauth\]'/" {} \;)
