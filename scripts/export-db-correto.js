...
`;
    ...
    // Exportar testes (modelo "tests")
    console.log('Exportando testes...');
    const tests = await prisma.tests.findMany();
    sqlContent += await generateInsert('tests', 
    ...
    sqlContent += await generateInsert('Stage', 
      ['id', 'title', 'description', 'order', 'testId', 'createdAt', 'updatedAt'], 
      stages);
    ...
    sqlContent += await generateInsert('Question', 
      ['id', 'text', 'stageId', 'categoryId', 'createdAt', 'updatedAt'], 
      questions);
    ...
    // Exportar relações entre testes e questões
    console.log('Exportando relações entre testes e questões...');
    const testQuestions = await prisma.testQuestion.findMany();
    sqlContent += await generateInsert('TestQuestion', 
      ['id', 'testId', 'questionId', 'stageId', 'order', 'createdAt', 'updatedAt'], 
      testQuestions);
